...
case LOCALE_zhTW: // 繁体中文
{
    ...
    break;
                    ...
                    case LOCALE_ruRU:
                    {
                        ss2 << "Congrats on Level " << static_cast<int>(player->GetLevel()) << " " << player->GetName() << "! You've been awarded " << money << " gold and a few treasures!";
                        break;
                    }
                    case LOCALE_esES:
                    case LOCALE_esMX:
                    {
                        ss2 << "¡Felicidades por el nivel " << static_cast<int>(player->GetLevel()) << " " << player->GetName() << " Se le ha concedido " << money << " oro y unos cuantos tesoros!";
                    }
                    default:
                        break;
                }
